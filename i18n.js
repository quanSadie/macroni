...
const I18N = {
  vi: {
    ...
    body_fat_label: 'Body fat % (tuỳ chọn)',
    body_fat_visual: 'Ước lượng từ ảnh',
    body_fat_note: 'Ảnh tham khảo cho nam. Nữ thường cao hơn 5-8%. Nhập % để dùng công thức Katch-McArdle (chính xác hơn cho người tập gym).',
    formula_mifflin: 'Mifflin-St Jeor',
    formula_katch: 'Katch-McArdle (theo lean mass)',
    act_1: 'Ít vận động',
  ...
  en: {
    ...
    body_fat_label: 'Body fat % (optional)',
    body_fat_visual: 'Estimate from chart',
    body_fat_note: 'Reference shown is for males; women typically run 5-8% higher. Entering body fat % switches BMR to Katch-McArdle (more accurate for athletic users).',
    formula_mifflin: 'Mifflin-St Jeor',
    formula_katch: 'Katch-McArdle (lean-mass based)',
    act_1: 'Sedentary',
